...
## 2026 BECE Registration: Deadlines, Process, and Fees

### Official 2026 Deadlines

Registration for the 2026 NECO BECE has now **closed**, but here are the confirmed dates for reference and record:

| Milestone | Date |
|---|---|
| Normal registration deadline | **Wednesday, 1 April 2026** (later extended to 4 April) |
...
> [!CAUTION]
> **Late registration penalty:** ₦5,000 per candidate, as confirmed in NECO's official fee schedules.

---

### Step-by-Step Registration Process (For Schools)
...
**English Studies**
English is the subject most parents worry about least and students struggle with most. The paper tests five distinct skill areas:
...
> [!CAUTION]
> A very common error in the exam: candidates write a **formal letter** when the question asks for an **informal letter**, or vice versa. This alone can cost up to 15 marks. Read every question instruction twice.

**Mathematics**
The syllabus covers four broad areas:
- Number and Numeration (fractions, percentages, indices, ratios, standard form)
- Algebraic Processes (simple equations, simultaneous equations, factorisation)
- Geometry and Mensuration (areas, volumes, angles, bearings)
...
This is a single subject that bundles four areas of learning:
- Basic Science (human body systems, photosynthesis, ecology, energy forms)
- Basic Technology (simple machines, materials and properties, drawing)
...
> [!NOTE]
> Subject selection should reflect the student's actual teaching and learning in school. Registering for a subject the school does not teach is a recipe for failure that is entirely avoidable.

---

## The BECE Grading System Explained

The BECE result is a combination of:
- Continuous Assessment scores (uploaded by the school during registration)
- Paper I (Objective) score
- Paper II (Essay/Theory) score

To earn the **Basic Education Certificate** and gain admission into SS1, a candidate must:

1. Sit for a **minimum of 9 subjects**
2. Obtain passes in at least **6 subjects**
3. Those 6 must **include English Studies and Mathematics**
...
## Checking Your BECE Result in 2026
...
1. Purchase a **NECO result checker token** from an authorised vendor or online through the NECO portal
2. Visit the official result portal at **neco.gov.ng**
3. Select the examination year (**2026**) and type (**Basic Education Certificate Examination**)
4. Enter your token number and **candidate registration number** (found on your photocard)
...
## Key Links and Official Sources

| Resource | Link |
|---|---|
| NECO Official Website | [neco.gov.ng](https://neco.gov.ng) |
| BECE Registration Portal | [bece.neco.gov.ng](https://bece.neco.gov.ng) |
| BECE Result Checker | [neco.gov.ng](https://neco.gov.ng) |
| Email NECO | info@neco.gov.ng |
...
*This guide is maintained for informational purposes. Always verify fee amounts and deadlines directly at **neco.gov.ng** before taking action, as NECO may update figures without public notice.*